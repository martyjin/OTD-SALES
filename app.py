...
with st.expander("🔎 필터", expanded=True):
    ...
    sel_month = c1.selectbox("기준 월(당월)", all_months[0])
    sel_sites = c2.multiselect("사이트",  all_sites,  default=all_sites)
    sel_brands= c3.multiselect("브랜드", all_brands, default=all_brands)
